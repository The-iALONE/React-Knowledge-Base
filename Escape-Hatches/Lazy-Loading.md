...
`bundle` بزرگ = زمان بارگذاری اولیه طولانی. همه کامپوننت‌ها در اولین بازدید لازم نیستند — مثلاً صفحه تنظیمات یا پنل ادمین.
...
- در Next.js از `next/dynamic` برای کنترل SSR استفاده کنید (M10)
